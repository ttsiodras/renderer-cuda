...
void ModeDescription()
{
    ...
    result += " 光源(F5):"; result += g_bUseSpecular?"ON,":"OFF,";
    result += " 插值(F6):"; result += g_bUsePhongInterp?"ON,":"OFF,";
    result += " 反射(F7):"; result += g_bUseReflections?"ON,":"OFF,";
    result += " 阴影(F8):"; result += g_bUseShadows?"ON,":"OFF,";
    result += " 抗锯齿(F9):"; result += g_bUseAntialiasing?"ON":"OFF";
